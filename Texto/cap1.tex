...
Agora note que a definição apresentada por Cantor distingue conjuntos e elementos como sendo objetos diferentes, e assim, a teoria dos conjuntos de cantor não tem um único objeto fundamental, mas dois, sendo eles, os conjuntos e os elementos. Além disso, a Definição \ref{def:Cantor} possui a exigência sobre dois aspectos da natureza dos elementos em um conjunto, a saber:  (1) Os elementos devem ser distintos entre si\sidefootnote{Em um conjunto não é permitido a repetição de elementos.} e (2) eles (os elementos) devem ser bem-definidos.
...
\begin{atencao}[Captura de variáveis.]\label{note:DummyEmConjunto}
...
\begin{itemize}
  \item[(a)] $\mathbb{N}$, representa o conjunto dos números naturais\sidefootnote{Lembre-se que aqui neste documento $0$ é obrigatoriamente um número natural}.
