...
%---------------------------------------------------------------------------------------
\theoremstyle{claim}
\newtheorem{principio}{{\footnotesize\color{YellowOrange}\manstar} Princípio}
\tcolorboxenvironment{principio}{
  boxrule=0pt,
  boxsep=0pt,
  blanker,
  borderline west={1pt}{0pt}{violet},
  sharp corners,
  before skip=10pt,
  after skip=10pt,
  left=5pt,
